...
def letter_count(text,encoding):
    ...
    for key,value in letterCounts.items():
        ...
        times.append(100*value/letterSum)
...
def FrequentWord_Count(text,encoding):
    ...
    for i in range(10):
        ...
        wordlist.append(word_sorted[i][0])
        frequency.append(word_sorted[i][1])

    plt.subplot(2,  1,  2)    
    plt.bar(wordlist,frequency, align =  'center') 
    plt.title('Frequent Word') 
